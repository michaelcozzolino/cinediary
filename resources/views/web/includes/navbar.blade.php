...
<nav class="navbar navbar-expand-lg">
    ...
    <a class="navbar-brand" href="index-2.html">
        ...
        <img src="{{ url("css/images/logo.svg") }}" alt="logo" width="150" class="logo">
        <!-- INSERT YOUR WHITE LOGO HERE -->
        <img src="{{ url("css/images/logo-white.svg")}}" alt="white logo" width="150" class="logo-white">
    </a>
        ...
        <ul class="navbar-nav mx-auto" id="main-menu">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <!-- Menu Item -->
                    <li>
                        <a class="dropdown-item" href="index-2.html">Home Version 1</a>
                    </li>
        ...
        <ul class="navbar-nav extra-nav">
            ...
            <li class="nav-item m-auto">
                {{--<a href="#login-register-popup" class="btn btn-main btn-effect login-btn popup-with-zoom-anim">
                    <i class="icon-user"></i>Register or Login
                </a>--}}
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a id="registerButton" href="#login-register-popup" class="signUpClick btn btn-main btn-effect login-btn popup-with-zoom-anim"><i class="icon-user"></i>Register</a>
                    <a id="loginButton" href="#login-register-popup" class="signInClick btn btn-main btn-effect login-btn popup-with-zoom-anim"><i class="icon-login"></i> Login</a>
                </div>
            </li>
        </ul>
        <!-- ====== End of Extra Nav ====== -->
