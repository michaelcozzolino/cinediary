<template>
    ...
    >
        <MDBModalHeader>
            <MDBModalTitle id="create-new-diary-model-label" v-text="this.__('create new diary')"/>
        </MDBModalHeader>
        <form @submit.prevent="createNewDiary()">
            ...
            <MDBModalBody>
                <MDBInput
                    ...
                    @input="this.createNewDiaryModal.form.clearErrors('diaryName')"
                />
            ...
            <MDBModalFooter>
                <MDBBtn type="submit" color="primary" v-text="this.__('create')"/>
            </MDBModalFooter>
        </form>
    </MDBModal>
</template>
