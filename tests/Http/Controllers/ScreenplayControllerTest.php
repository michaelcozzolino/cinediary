...
class ScreenplayControllerTest extends TestCase
{
    use RefreshDatabase;
...
//        $this->swap(TMDBServiceProvider::class, $this->createMock(TMDBServiceProvider::class));
    ...
    public function it_cannot_store_a_screenplay_because_it_does_not_exists_in_tmbd_api()
    {
        ...
        $response = $this->post(route('diaries.movies.store', ['diary' => $this->diaries['watched']]), [
            ...
            ->assertRedirect()
            ->assertSessionHas('message', 'The requested movie does not exist!');
